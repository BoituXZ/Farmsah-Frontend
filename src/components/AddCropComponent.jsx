...
import {
    Box, InputLabel, MenuItem, Select, TextField, Button,
    Typography, IconButton, Modal, Paper, Stack, FormControl, useTheme
} from "@mui/material";
...
const AddCropComponent = () => {
    ...
    const [newPastCrops, setPastCrops] = useState(""); // Represents 'AI Suggestions' in your logic
    ...
    const modalTitle = headerTitle ? headerTitle.charAt(0).toUpperCase() + headerTitle.slice(1) : "Crop";
    ...
    const handleSubmit = async () => { /* Original submit logic preserved */ };

    useEffect(() => {
        if (open) { /* Original fetchFarms logic preserved */ }
    }, [open]);
            ...
            >
                <Paper
                    ...
                    sx={{
                        ...
                        cursor: 'pointer',
                        // Using a solid color from your theme for better visibility
            ...
            <Modal open={open} onClose={handleClose}>
                ...
                >
                    ...
                    <Stack component="form" spacing={2.5}>
                        ...
                        />
                        <TextField
                            label="AI Suggestions / Notes" // Label clarified
                            value={newPastCrops} // Corresponds to aiSuggestions
